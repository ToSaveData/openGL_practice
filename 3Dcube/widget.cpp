...
void Widget::paintGL( )
{
    ...
    // 방향성 때문에 순서에 일관성이 있다.
#if 1
    static GLubyte front[]  = {0,3,1,2}; 	// front face cw
    static GLubyte back[]   = {5,6,4,7}; 	// back face
    static GLubyte top[]    = {3,7,2,6}; 	// top face cw
    static GLubyte bottom[] = {5,4,1,0}; 	// bottom face
    static GLubyte left[]   = {4,7,0,3}; 		// left face
    static GLubyte right[]  = {6,5,2,1}; 		// right face cw
    //2130
#else
    static GLubyte front[]  = {2,1,3,0}; 	// front face
    static GLubyte back[]   = {5,4,6,7}; 	// back face
    static GLubyte top[]    = {3,7,2,6}; 	// top face
    static GLubyte bottom[] = {0,4,1,5}; 	// bottom face
    static GLubyte left[]   = {0,4,3,7};    // left face
